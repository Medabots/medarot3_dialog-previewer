...
$windowim=imagecreatefrompng('./window/window.png');
imagealphablending($windowim,true);

// Preload indicator.

$indicatorim=imagecreatefrompng('./window/indicator.png');
...
while($pagenum<$numpages) {
	...
	$windowverticaloffset=$portraitverticaloffset+32;
	$indicatorverticaloffset=$windowverticaloffset+24;
	$textverticaloffset=$windowverticaloffset+8;
